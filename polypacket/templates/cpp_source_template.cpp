...
HandlerStatus_e ${proto.camelPrefix()}Service::send(int iface, ${proto.prefix}_packet_t* packet)
{
  HandlerStatus_e ${proto.prefix}_status;
...
/**
  ...
  */
HandlerStatus_e ${proto.camelPrefix()}Service::PingHandler(${proto.prefix}_packet_t* ${proto.prefix}_ping, ${proto.prefix}_packet_t* ${proto.prefix}_ack)
{
...
/**
  ...
  *@return PACKET_HANDLED
  */
HandlerStatus_e ${proto.camelPrefix()}Service::Ackhandler(${proto.prefix}_packet_t* ${proto.prefix}_ack)
{
  return PACKET_HANDLED;
}
...
/**
  ...
  */
HandlerStatus_e ${proto.camelPrefix()}Service::${packet.camel()}Handler(${proto.prefix}_packet_t* ${proto.prefix}_${packet.name})
%else:
/**
  *@brief Handler for receiving ${packet.name} packets
  *@param ${packet.name} incoming ${packet.name} packet
  ...
  *@return handling ${proto.prefix}_status
  */
HandlerStatus_e ${proto.camelPrefix()}Service::${packet.camel()}Handler(${proto.prefix}_packet_t* ${proto.prefix}_${packet.name}, ${proto.prefix}_packet_t* ${proto.prefix}_${packet.response.name})
%endif
{
...
/**
  ...
  *@return handling ${proto.prefix}_status
  */
HandlerStatus_e ${proto.camelPrefix()}Service::defaultHandler( ${proto.prefix}_packet_t * ${proto.prefix}_packet, ${proto.prefix}_packet_t* ${proto.prefix}_response)
{
...
/**
  ...
  */
void ${proto.camelPrefix()}Packet::set${field.camel()}(${proto.prefix}_packet_t* packet, const ${field.getParamType()} val)
% else:
/**
...
%endif
%if field.isArray:
void ${proto.camelPrefix()}Packet::get${field.camel()}(${proto.prefix}_packet_t* packet, ${field.getParamType()} val)
{
  poly_packet_get_field(packet, ${field.globalName}, val);
}
% else:
${field.getParamType()} ${proto.camelPrefix()}Packet::get${field.camel()}(${proto.prefix}_packet_t* packet)
{
